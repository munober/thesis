...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        Dataset & Amount of Padding & Webcam Demo Accuracy  \\ \hline
        1 & 20 \% & ~70-80 \%  \\ \hline
        2 & 50 \% & ~70-80 \%  \\ \hline
        3 & 80 \% & ~70-80 \%  \\ \hline
    \end{tabular}
    \caption{Padding was applied as a percentage, divided randomly and unevenly between the left/right and up/down side pairs respectively. All datasets had 30,000 grayscale images with sides of 100*100. The amount of padding has not significantly influenced real-world performance on the webcam demo.}
